...
class DeepSeekBackend(HTTPClientMixin, BaseBackend):
    name = "deepseek"
    ...
    def complete(self, prompt, *, model=None, temperature=None, max_tokens=None,
        ...
        try:
            ...
            log.warning("deepseek complete failed: %r", exc)
            raise
    ...
    def embed(self, inputs, *, model=None):
        ...
        log.info("deepseek does not host embeddings; returning dry-run")
        return self._dry_run_embed(inputs, model=m)
