# CIS Azure Foundations 1.7 — Ensure smart lockout thresholds are configured
...
## Description
Ensure smart lockout thresholds are configured. Tune lockout to defeat credential stuffing.
