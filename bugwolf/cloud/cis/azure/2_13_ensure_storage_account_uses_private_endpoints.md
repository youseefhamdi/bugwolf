# CIS Azure Foundations 2.13 — Ensure storage account uses private endpoints
...
## Description
Ensure storage account uses private endpoints. Private Link from the workload VNet.
