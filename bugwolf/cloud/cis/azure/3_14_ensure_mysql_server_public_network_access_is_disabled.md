# CIS Azure Foundations 3.14 — Ensure MySQL server public network access is disabled
...
## Description
Ensure MySQL server public network access is disabled. Private endpoint only.
