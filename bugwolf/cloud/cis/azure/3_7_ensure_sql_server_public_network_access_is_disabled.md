# CIS Azure Foundations 3.7 — Ensure SQL server public network access is disabled
...
## Description
Ensure SQL server public network access is disabled. Private endpoint only.
