# CIS Azure Foundations 3.10 — Ensure PostgreSQL server connection throttling is configured
...
## Description
Ensure PostgreSQL server connection throttling is configured. Short-term brute-force mitigation.
