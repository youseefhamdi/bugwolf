# CIS Azure Foundations 9.4 — Ensure AKS has Defender for Containers enabled

**ID:** 9.4
**Severity:** medium
**Category:** Kubernetes Service (AKS)

## Description
Ensure AKS has Defender for Containers enabled. Runtime threat detection.
