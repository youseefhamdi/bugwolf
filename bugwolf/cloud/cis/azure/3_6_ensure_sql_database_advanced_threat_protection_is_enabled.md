# CIS Azure Foundations 3.6 — Ensure SQL database advanced threat protection is enabled
...
## Description
Ensure SQL database advanced threat protection is enabled. Defender for SQL alerts.
