# CIS Azure Foundations 1.21 — Ensure sign-in risk policy blocks risky sign-ins
...
## Description
Ensure sign-in risk policy blocks risky sign-ins. Conditional Access block on sign-in risk = high.
