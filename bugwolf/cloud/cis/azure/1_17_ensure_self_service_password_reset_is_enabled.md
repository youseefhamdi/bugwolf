# CIS Azure Foundations 1.17 — Ensure self-service password reset is enabled
...
## Description
Ensure self-service password reset is enabled. Reduces helpdesk load + enforces MFA.
