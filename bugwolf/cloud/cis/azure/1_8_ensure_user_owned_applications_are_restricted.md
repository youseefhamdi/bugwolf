# CIS Azure Foundations 1.8 — Ensure user-owned applications are restricted
...
## Description
Ensure user-owned applications are restricted. Block end-user consent to multi-tenant apps.
