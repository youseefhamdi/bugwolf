# CIS Azure Foundations 4.13 — Ensure email notifications for high severity alerts are configured
...
## Description
Ensure email notifications for high severity alerts are configured. Defender alert routing.
