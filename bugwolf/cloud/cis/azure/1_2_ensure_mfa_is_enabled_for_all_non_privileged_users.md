# CIS Azure Foundations 1.2 — Ensure MFA is enabled for all non-privileged users
...
## Description
Ensure MFA is enabled for all non-privileged users. Drive MFA enrollment via Security Defaults or CA.
