# CIS Azure Foundations 3.9 — Ensure PostgreSQL server has Entra ID authentication enabled
...
## Description
Ensure PostgreSQL server has Entra ID authentication enabled. Passwordless DB auth.
