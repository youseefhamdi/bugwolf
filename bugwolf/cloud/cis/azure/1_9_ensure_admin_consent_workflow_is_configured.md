# CIS Azure Foundations 1.9 — Ensure admin consent workflow is configured
...
## Description
Ensure admin consent workflow is configured. Route high-risk consent requests to a reviewer.
