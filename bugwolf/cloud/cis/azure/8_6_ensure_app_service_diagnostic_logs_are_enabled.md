# CIS Azure Foundations 8.6 — Ensure App Service diagnostic logs are enabled
...
## Description
Ensure App Service diagnostic logs are enabled. AppServiceHTTPLogs + AppServiceConsoleLogs.
