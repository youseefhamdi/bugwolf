# CIS Azure Foundations 3.11 — Ensure PostgreSQL server infrastructure encryption is enabled
...
## Description
Ensure PostgreSQL server infrastructure encryption is enabled. Double-encryption with platform-managed key.
