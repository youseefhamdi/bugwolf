# CIS Azure Foundations 4.12 — Ensure auto-provisioning of monitoring agent is enabled
...
## Description
Ensure auto-provisioning of monitoring agent is enabled. MMA agent auto-install.
