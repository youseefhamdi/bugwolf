# CIS Azure Foundations 1.14 — Ensure managed identities are preferred over secrets
...
## Description
Ensure managed identities are preferred over secrets. Reduce secret rotation toil.
