# CIS Azure Foundations 4.4 — Ensure Activity Log alerts exist for critical operations
...
## Description
Ensure Activity Log alerts exist for critical operations. Alert on subscription-level changes.
