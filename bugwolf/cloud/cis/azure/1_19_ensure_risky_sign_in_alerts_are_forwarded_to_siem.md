# CIS Azure Foundations 1.19 — Ensure risky sign-in alerts are forwarded to SIEM
...
## Description
Ensure risky sign-in alerts are forwarded to SIEM. Stream Identity Protection alerts.
