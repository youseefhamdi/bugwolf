# CIS Azure Foundations 1.1 — Ensure MFA is enabled for all privileged users
...
## Description
Ensure MFA is enabled for all privileged users. Conditional Access + per-user MFA registration.
