# CIS Azure Foundations 5.4 — Ensure VM managed identity is used for storage access
...
## Description
Ensure VM managed identity is used for storage access. No secrets on the VM.
