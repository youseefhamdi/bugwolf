# CIS Azure Foundations 1.6 — Ensure password protection is enabled for hybrid users
...
## Description
Ensure password protection is enabled for hybrid users. Enable Azure AD Password Protection.
