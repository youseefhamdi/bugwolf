# CIS Azure Foundations 2.4 — Ensure storage account uses CMK for blobs
...
## Description
Ensure storage account uses CMK for blobs. Customer-managed key for regulated workloads.
