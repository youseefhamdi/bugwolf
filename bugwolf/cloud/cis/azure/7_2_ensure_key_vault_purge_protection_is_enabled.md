# CIS Azure Foundations 7.2 — Ensure Key Vault purge protection is enabled
...
## Description
Ensure Key Vault purge protection is enabled. Block purge during retention period.
