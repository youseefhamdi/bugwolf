# CIS Azure Foundations 6.6 — Ensure WAF is in front of every public web app
...
## Description
Ensure WAF is in front of every public web app. WAF v2 on App Gateway / Front Door.
