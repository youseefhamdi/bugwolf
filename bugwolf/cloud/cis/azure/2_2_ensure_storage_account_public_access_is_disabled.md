# CIS Azure Foundations 2.2 — Ensure storage account public access is disabled
...
## Description
Ensure storage account public access is disabled. Set AllowBlobPublicAccess=false at account level.
