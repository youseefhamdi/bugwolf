# CIS Azure Foundations 3.13 — Ensure MySQL server has Entra ID authentication enabled
...
## Description
Ensure MySQL server has Entra ID authentication enabled. Passwordless DB auth.
