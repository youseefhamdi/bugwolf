# CIS Azure Foundations 3.4 — Ensure SQL database transparent data encryption is enabled
...
## Description
Ensure SQL database transparent data encryption is enabled. TDE with customer-managed key.
