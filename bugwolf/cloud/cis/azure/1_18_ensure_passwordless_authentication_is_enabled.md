# CIS Azure Foundations 1.18 — Ensure passwordless authentication is enabled
...
## Description
Ensure passwordless authentication is enabled. FIDO2 / Windows Hello / Authenticator.
