# CIS Azure Foundations 4.14 — Ensure Azure Monitor alerts exist for critical services
...
## Description
Ensure Azure Monitor alerts exist for critical services. Alert on service health events.
