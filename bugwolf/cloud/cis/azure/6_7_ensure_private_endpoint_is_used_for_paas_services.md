# CIS Azure Foundations 6.7 — Ensure private endpoint is used for PaaS services
...
## Description
Ensure private endpoint is used for PaaS services. Private Link for SQL, Storage, KV.
