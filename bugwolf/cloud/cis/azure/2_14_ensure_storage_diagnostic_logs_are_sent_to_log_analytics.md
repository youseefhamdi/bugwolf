# CIS Azure Foundations 2.14 — Ensure storage diagnostic logs are sent to Log Analytics
...
## Description
Ensure storage diagnostic logs are sent to Log Analytics. Audit all data-plane reads/writes.
