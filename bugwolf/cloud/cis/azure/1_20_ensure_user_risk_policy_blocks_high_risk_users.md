# CIS Azure Foundations 1.20 — Ensure user risk policy blocks high-risk users
...
## Description
Ensure user risk policy blocks high-risk users. Conditional Access block on user risk = high.
