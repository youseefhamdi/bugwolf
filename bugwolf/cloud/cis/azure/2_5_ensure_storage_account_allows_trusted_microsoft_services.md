# CIS Azure Foundations 2.5 — Ensure storage account allows trusted Microsoft services
...
## Description
Ensure storage account allows trusted Microsoft services. Restrict network access to trusted Azure services.
