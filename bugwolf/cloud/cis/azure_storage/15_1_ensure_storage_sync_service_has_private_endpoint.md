# CIS Azure Storage 15.1 — Ensure Storage Sync service has private endpoint
...
## Description
Ensure Storage Sync service has private endpoint. This control is part of the Azure Storage Benchmark
