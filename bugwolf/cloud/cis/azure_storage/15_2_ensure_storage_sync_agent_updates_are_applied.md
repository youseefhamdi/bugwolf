# CIS Azure Storage 15.2 — Ensure Storage Sync agent updates are applied
...
## Description
Ensure Storage Sync agent updates are applied. This control is part of the Azure Storage Benchmark
