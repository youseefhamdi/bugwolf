# CIS Azure Storage 10.7 — Ensure storage account has private endpoint configured
...
## Description
Ensure storage account has private endpoint configured. This control is part of the Azure Storage Benchmark
