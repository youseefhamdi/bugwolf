# CIS Azure Storage 10.15 — Ensure storage account has immutable blob policy
...
## Description
Ensure storage account has immutable blob policy. This control is part of the Azure Storage Benchmark
