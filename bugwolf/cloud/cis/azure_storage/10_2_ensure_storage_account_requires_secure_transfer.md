# CIS Azure Storage 10.2 — Ensure storage account requires secure transfer
...
## Description
Ensure storage account requires secure transfer. This control is part of the Azure Storage Benchmark
