# CIS Azure Storage 12.2 — Ensure Queue Storage data is encrypted with CMK
...
## Description
Ensure Queue Storage data is encrypted with CMK. This control is part of the Azure Storage Benchmark
