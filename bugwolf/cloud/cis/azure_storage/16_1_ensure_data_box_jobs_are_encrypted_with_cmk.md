# CIS Azure Storage 16.1 — Ensure Data Box jobs are encrypted with CMK
...
## Description
Ensure Data Box jobs are encrypted with CMK. This control is part of the Azure Storage Benchmark
