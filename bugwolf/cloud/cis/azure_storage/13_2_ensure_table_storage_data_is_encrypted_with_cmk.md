# CIS Azure Storage 13.2 — Ensure Table Storage data is encrypted with CMK
...
## Description
Ensure Table Storage data is encrypted with CMK. This control is part of the Azure Storage Benchmark
