# CIS Azure Storage 10.4 — Ensure storage account uses CMK for blob encryption
...
## Description
Ensure storage account uses CMK for blob encryption. This control is part of the Azure Storage Benchmark
