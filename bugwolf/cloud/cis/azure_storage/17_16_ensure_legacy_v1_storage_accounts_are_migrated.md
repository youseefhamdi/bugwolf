# CIS Azure Storage 17.16 — Ensure legacy v1 storage accounts are migrated
...
## Description
Ensure legacy v1 storage accounts are migrated. This control is part of the Azure Storage Benchmark
