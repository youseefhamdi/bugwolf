# CIS Azure Storage 13.1 — Ensure Table Storage has logging enabled
...
## Description
Ensure Table Storage has logging enabled. This control is part of the Azure Storage Benchmark
