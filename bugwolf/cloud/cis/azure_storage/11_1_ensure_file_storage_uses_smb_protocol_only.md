# CIS Azure Storage 11.1 — Ensure File Storage uses SMB protocol only
...
## Description
Ensure File Storage uses SMB protocol only. This control is part of the Azure Storage Benchmark
