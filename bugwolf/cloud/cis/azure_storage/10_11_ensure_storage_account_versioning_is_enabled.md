# CIS Azure Storage 10.11 — Ensure storage account versioning is enabled
...
## Description
Ensure storage account versioning is enabled. This control is part of the Azure Storage Benchmark
