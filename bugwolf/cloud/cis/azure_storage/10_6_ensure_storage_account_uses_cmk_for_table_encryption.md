# CIS Azure Storage 10.6 — Ensure storage account uses CMK for table encryption
...
## Description
Ensure storage account uses CMK for table encryption. This control is part of the Azure Storage Benchmark
