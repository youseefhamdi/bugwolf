# CIS Azure Storage 10.5 — Ensure storage account uses CMK for queue encryption
...
## Description
Ensure storage account uses CMK for queue encryption. This control is part of the Azure Storage Benchmark
