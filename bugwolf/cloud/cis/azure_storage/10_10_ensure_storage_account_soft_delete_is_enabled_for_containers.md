# CIS Azure Storage 10.10 — Ensure storage account soft delete is enabled for containers
...
## Description
Ensure storage account soft delete is enabled for containers. This control is part of the Azure Storage Benchmark
