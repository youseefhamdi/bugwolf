# CIS Azure Storage 10.8 — Ensure storage account default network access rule is Deny
...
## Description
Ensure storage account default network access rule is Deny. This control is part of the Azure Storage Benchmark
