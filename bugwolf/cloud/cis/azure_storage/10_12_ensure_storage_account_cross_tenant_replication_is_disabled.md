# CIS Azure Storage 10.12 — Ensure storage account cross-tenant replication is disabled
...
## Description
Ensure storage account cross-tenant replication is disabled. This control is part of the Azure Storage Benchmark
