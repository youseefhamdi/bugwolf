# CIS Azure Storage 10.14 — Ensure storage account has diagnostic logs enabled
...
## Description
Ensure storage account has diagnostic logs enabled. This control is part of the Azure Storage Benchmark
