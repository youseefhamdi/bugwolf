# CIS Azure Storage 10.3 — Ensure storage account allows public blob access disabled
...
## Description
Ensure storage account allows public blob access disabled. This control is part of the Azure Storage Benchmark
