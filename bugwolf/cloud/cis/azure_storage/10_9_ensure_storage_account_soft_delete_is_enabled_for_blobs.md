# CIS Azure Storage 10.9 — Ensure storage account soft delete is enabled for blobs
...
## Description
Ensure storage account soft delete is enabled for blobs. This control is part of the Azure Storage Benchmark
