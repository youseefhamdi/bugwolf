# CIS AWS Foundations 2.0 — 4.2.2 Ensure S3 default encryption uses SSE-KMS for regulated buckets
...
## Description
Ensure S3 default encryption uses SSE-KMS for regulated buckets. S3 and EBS in 2.0 mandate default-deny public access at the account level via Block Public Access, SSE-KMS for regulated data, and object-lock for compliance retention.
