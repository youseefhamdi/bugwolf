# CIS AWS Foundations 1.0 — 5.2 Ensure RDS instances have automatic minor version upgrades enabled
...
## Description
Avoid running unpatched engine versions.
...
## Audit Procedure
1. `aws rds describe-db-instances | jq '.DBInstances[].AutoMinorVersionUpgrade'`.
