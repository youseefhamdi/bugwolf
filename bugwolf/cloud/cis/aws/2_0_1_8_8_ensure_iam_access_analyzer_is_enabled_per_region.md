# CIS AWS Foundations 2.0 — 1.8.8 Ensure IAM Access Analyzer is enabled per region
...
## Description
Ensure IAM Access Analyzer is enabled per region. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
