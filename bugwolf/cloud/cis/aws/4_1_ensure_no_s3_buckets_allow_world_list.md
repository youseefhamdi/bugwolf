# CIS AWS Foundations 1.0 — 4.1 Ensure no S3 buckets allow world-list
...
## Description
Public-readable buckets leak customer data.
...
## Audit Procedure
1. `aws s3api list-buckets | jq '.Buckets[].Name'` and check policy.
...
## Remediation
Set `BlockPublicAcls`, `BlockPublicPolicy`, `IgnorePublicAcls`, `RestrictPublicBuckets` true.
