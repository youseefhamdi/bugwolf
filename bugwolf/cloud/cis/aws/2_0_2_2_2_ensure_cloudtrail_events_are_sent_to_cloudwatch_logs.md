# CIS AWS Foundations 2.0 — 2.2.2 Ensure CloudTrail events are sent to CloudWatch Logs
...
## Description
Ensure CloudTrail events are sent to CloudWatch Logs. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
