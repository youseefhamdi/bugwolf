# CIS AWS Foundations 2.0 — 2.7.7 Ensure AWS Config rules use AWS-managed rule packs
...
## Description
Ensure AWS Config rules use AWS-managed rule packs. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
