# CIS AWS Foundations 2.0 — 5.2.2 Ensure RDS performance insights retention is 7+ days
...
## Description
Ensure RDS performance insights retention is 7+ days. RDS, Aurora, and DynamoDB in 2.0 require IAM auth, encryption-at-rest, and automated minor-version upgrades across the fleet.
