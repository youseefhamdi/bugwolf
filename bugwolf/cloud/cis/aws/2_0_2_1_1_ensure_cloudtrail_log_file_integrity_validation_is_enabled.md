# CIS AWS Foundations 2.0 — 2.1.1 Ensure CloudTrail log file integrity validation is enabled
...
## Description
Ensure CloudTrail log file integrity validation is enabled. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
