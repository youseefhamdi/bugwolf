# CIS AWS Foundations 1.0 — 1.10 Ensure access keys are rotated every 90 days
...
## Description
Long-lived access keys accumulate blast radius.
...
## Audit Procedure
1. Inspect `access_key_1_last_rotated` and `access_key_2_last_rotated`.
...
## Remediation
Replace the access key, disable the old key, then delete after 30 days.
