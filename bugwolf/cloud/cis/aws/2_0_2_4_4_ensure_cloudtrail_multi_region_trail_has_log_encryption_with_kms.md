# CIS AWS Foundations 2.0 — 2.4.4 Ensure CloudTrail multi-region trail has log encryption with KMS
...
## Description
Ensure CloudTrail multi-region trail has log encryption with KMS. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
