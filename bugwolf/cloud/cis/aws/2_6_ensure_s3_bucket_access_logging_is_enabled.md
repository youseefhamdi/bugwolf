# CIS AWS Foundations 1.0 — 2.6 Ensure S3 bucket access logging is enabled
...
## Description
Access logs are required for forensic analysis of bucket compromise.
...
## Audit Procedure
1. `aws s3api get-bucket-logging --bucket <name>`.
...
## Remediation
Enable server access logging; target a dedicated logging bucket.
