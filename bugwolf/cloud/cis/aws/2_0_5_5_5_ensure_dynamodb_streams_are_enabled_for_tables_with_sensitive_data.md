# CIS AWS Foundations 2.0 — 5.5.5 Ensure DynamoDB streams are enabled for tables with sensitive data
...
## Description
Ensure DynamoDB streams are enabled for tables with sensitive data. RDS, Aurora, and DynamoDB in 2.0 require IAM auth, encryption-at-rest, and automated minor-version upgrades across the fleet.
