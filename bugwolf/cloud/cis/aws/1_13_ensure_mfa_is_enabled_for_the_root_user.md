# CIS AWS Foundations 1.0 — 1.13 Ensure MFA is enabled for the root user
...
## Description
Same as 1.2 — included here as a separate audit hook in Prowler.
...
## Audit Procedure
1. Compare against the Prowler `extra714` finding.
