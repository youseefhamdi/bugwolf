# CIS AWS Foundations 2.0 — 1.6.6 Ensure IAM policy simulator is enabled for reviewers
...
## Description
Ensure IAM policy simulator is enabled for reviewers. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
