# CIS AWS Foundations 1.0 — 3.3 Ensure the default security group of every VPC restricts all traffic
...
## Description
The default SG should be the deny-all posture; missing this is a frequent finding.
...
## Audit Procedure
1. `aws ec2 describe-security-groups --filters Name=group-name,Values=default | jq '.SecurityGroups[].IpPermissions'`.
...
## Remediation
Strip all rules from the default SG; explicit SGs handle allow-list.
