# CIS AWS Foundations 2.0 — 1.1.1 Ensure IAM password policy requires minimum length 14 or greater
...
## Description
Ensure IAM password policy requires minimum length 14 or greater. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
