# CIS AWS Foundations 1.0 — 3.7 Ensure NAT gateways are not over-provisioned
...
## Audit Procedure
1. Inspect CloudWatch metrics for `BytesOutToDestination`.
...
## Remediation
Right-size the NAT; consider NAT Gateway consolidation.
