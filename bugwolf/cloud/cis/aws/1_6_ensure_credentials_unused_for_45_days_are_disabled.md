# CIS AWS Foundations 1.0 — 1.6 Ensure credentials unused for 45 days are disabled
...
## Description
Stale credentials are a primary vector for long-tail compromise.
...
## Audit Procedure
1. Inspect credential report `password_last_used` and `access_key_1_last_used_date`.
...
## Remediation
Disable the user; archive the credentials; remove any access keys.
