# CIS AWS Foundations 1.0 — 1.7 Ensure IAM password policy requires minimum length of 14
...
## Description
Short passwords are brute-forceable; AWS' minimum is 14.
...
## Audit Procedure
1. `aws iam get-account-password-policy | jq .MinimumPasswordLength`.
...
## Remediation
Update the password policy via `aws iam update-account-password-policy`.
