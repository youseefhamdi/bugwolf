# CIS AWS Foundations 2.0 — 3.10.10 Ensure transit gateway route tables are least-scope
...
## Description
Ensure transit gateway route tables are least-scope. VPC and edge controls in 2.0 mandate explicit deny-by-default Security Groups, central egress via NAT, and TLS-only listeners across the public surface.
