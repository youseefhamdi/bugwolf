# CIS AWS Foundations 1.0 — 3.5 Ensure VPC flow logs are retained for at least 90 days
...
## Description
Short retention prevents IR from reconstructing the timeline.
...
## Audit Procedure
1. Inspect the CW Logs group retention.
...
## Remediation
Set retention to 90 days minimum; 365 for production.
