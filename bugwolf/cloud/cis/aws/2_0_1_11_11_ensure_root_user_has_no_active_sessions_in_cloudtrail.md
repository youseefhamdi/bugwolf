# CIS AWS Foundations 2.0 — 1.11.11 Ensure root user has no active sessions in CloudTrail
...
## Description
Ensure root user has no active sessions in CloudTrail. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
