# CIS AWS Foundations 2.0 — 1.14.14 Ensure unused IAM roles are detected weekly
...
## Description
Ensure unused IAM roles are detected weekly. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
