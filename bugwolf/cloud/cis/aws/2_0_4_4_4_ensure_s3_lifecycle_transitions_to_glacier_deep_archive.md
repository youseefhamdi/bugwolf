# CIS AWS Foundations 2.0 — 4.4.4 Ensure S3 lifecycle transitions to Glacier Deep Archive
...
## Description
Ensure S3 lifecycle transitions to Glacier Deep Archive. S3 and EBS in 2.0 mandate default-deny public access at the account level via Block Public Access, SSE-KMS for regulated data, and object-lock for compliance retention.
