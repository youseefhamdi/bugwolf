# CIS AWS Foundations 1.0 — 3.2 Ensure no security groups allow ingress from ::/0 to remote server administration ports
...
## Audit Procedure
1. `aws ec2 describe-security-groups | jq '.SecurityGroups[].IpPermissions[].Ipv6Ranges[]'`.
...
## Remediation
Remove IPv6 world ranges from SSH / RDP.
