# CIS AWS Foundations 2.0 — 2.10.10 Ensure CloudWatch log groups have retention >= 365 days
...
## Description
Ensure CloudWatch log groups have retention >= 365 days. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
