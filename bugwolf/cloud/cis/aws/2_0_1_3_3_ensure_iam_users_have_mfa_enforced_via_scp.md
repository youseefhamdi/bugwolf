# CIS AWS Foundations 2.0 — 1.3.3 Ensure IAM users have MFA enforced via SCP
...
## Description
Ensure IAM users have MFA enforced via SCP. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
