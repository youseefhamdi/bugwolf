# CIS AWS Foundations 2.0 — 1.2.2 Ensure no IAM policies allow wildcard resource on S3
...
## Description
Ensure no IAM policies allow wildcard resource on S3. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
