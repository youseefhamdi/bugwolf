# CIS AWS Foundations 2.0 — 2.9.9 Ensure CloudWatch alarms exist for root account activity
...
## Description
Ensure CloudWatch alarms exist for root account activity. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
