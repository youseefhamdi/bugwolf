# CIS AWS Foundations 1.0 — 4.7 Ensure S3 event notifications are configured for object operations
...
## Description
S3 events feed downstream DLP pipelines.
...
## Audit Procedure
1. Inspect notification configuration.
...
## Remediation
Configure SNS / SQS / Lambda notifications.
