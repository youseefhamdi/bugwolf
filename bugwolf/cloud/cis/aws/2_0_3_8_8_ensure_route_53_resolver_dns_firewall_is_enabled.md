# CIS AWS Foundations 2.0 — 3.8.8 Ensure Route 53 Resolver DNS firewall is enabled
...
## Description
Ensure Route 53 Resolver DNS firewall is enabled. VPC and edge controls in 2.0 mandate explicit deny-by-default Security Groups, central egress via NAT, and TLS-only listeners across the public surface.
