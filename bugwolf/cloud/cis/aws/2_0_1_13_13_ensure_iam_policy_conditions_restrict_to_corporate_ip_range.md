# CIS AWS Foundations 2.0 — 1.13.13 Ensure IAM policy conditions restrict to corporate IP range
...
## Description
Ensure IAM policy conditions restrict to corporate IP range. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
