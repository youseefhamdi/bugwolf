# CIS AWS Foundations 2.0 — 1.12.12 Ensure permissions boundaries are attached for elevated roles
...
## Description
Ensure permissions boundaries are attached for elevated roles. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
