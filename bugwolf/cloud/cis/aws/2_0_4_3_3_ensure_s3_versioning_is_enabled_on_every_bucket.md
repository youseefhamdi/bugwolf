# CIS AWS Foundations 2.0 — 4.3.3 Ensure S3 versioning is enabled on every bucket
...
## Description
Ensure S3 versioning is enabled on every bucket. S3 and EBS in 2.0 mandate default-deny public access at the account level via Block Public Access, SSE-KMS for regulated data, and object-lock for compliance retention.
