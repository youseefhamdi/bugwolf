# CIS AWS Foundations 2.0 — 2.11.11 Ensure VPC flow logs are delivered to S3 + CloudWatch
...
## Description
Ensure VPC flow logs are delivered to S3 + CloudWatch. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
