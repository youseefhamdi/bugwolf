# CIS AWS Foundations 1.0 — 2.1 Ensure CloudTrail is enabled in all regions
...
## Description
CloudTrail in a single region misses activity elsewhere; multi-region trails are required for full audit.
...
## Audit Procedure
1. `aws cloudtrail describe-trails | jq '.trailList[] | {Name, IsMultiRegionTrail}'`.
...
## Remediation
Convert trails to multi-region; ensure log file validation is on.
