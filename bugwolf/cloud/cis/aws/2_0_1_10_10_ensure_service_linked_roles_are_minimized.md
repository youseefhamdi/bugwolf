# CIS AWS Foundations 2.0 — 1.10.10 Ensure service-linked roles are minimized
...
## Description
Ensure service-linked roles are minimized. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
