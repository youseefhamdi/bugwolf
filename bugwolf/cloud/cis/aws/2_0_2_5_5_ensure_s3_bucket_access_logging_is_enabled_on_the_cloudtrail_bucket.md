# CIS AWS Foundations 2.0 — 2.5.5 Ensure S3 bucket access logging is enabled on the CloudTrail bucket
...
## Description
Ensure S3 bucket access logging is enabled on the CloudTrail bucket. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
