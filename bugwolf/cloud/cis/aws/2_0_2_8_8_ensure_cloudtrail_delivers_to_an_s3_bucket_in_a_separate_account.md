# CIS AWS Foundations 2.0 — 2.8.8 Ensure CloudTrail delivers to an S3 bucket in a separate account
...
## Description
Ensure CloudTrail delivers to an S3 bucket in a separate account. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
