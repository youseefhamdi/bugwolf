# CIS AWS Foundations 2.0 — 2.6.6 Ensure AWS Config is enabled in every active region
...
## Description
Ensure AWS Config is enabled in every active region. CloudTrail, CloudWatch, and AWS Config posture in 2.0 favors centralized log aggregation, KMS-encrypted archives, and event-driven remediation over per-account alarms.
