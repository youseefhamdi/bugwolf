# CIS AWS Foundations 2.0 — 4.7.7 Ensure RDS storage is encrypted at rest with CMK
...
## Description
Ensure RDS storage is encrypted at rest with CMK. S3 and EBS in 2.0 mandate default-deny public access at the account level via Block Public Access, SSE-KMS for regulated data, and object-lock for compliance retention.
