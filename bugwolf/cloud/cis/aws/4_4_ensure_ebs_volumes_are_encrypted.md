# CIS AWS Foundations 1.0 — 4.4 Ensure EBS volumes are encrypted
...
## Description
Unencrypted EBS volumes leak snapshot copies.
...
## Audit Procedure
1. `aws ec2 describe-volumes | jq '.Volumes[].Encrypted'`.
...
## Remediation
Re-create volumes encrypted; snapshot+copy with encryption.
