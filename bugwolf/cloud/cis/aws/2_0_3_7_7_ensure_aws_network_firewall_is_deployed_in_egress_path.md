# CIS AWS Foundations 2.0 — 3.7.7 Ensure AWS Network Firewall is deployed in egress path
...
## Description
Ensure AWS Network Firewall is deployed in egress path. VPC and edge controls in 2.0 mandate explicit deny-by-default Security Groups, central egress via NAT, and TLS-only listeners across the public surface.
