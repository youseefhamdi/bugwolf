# CIS AWS Foundations 1.0 — 1.8 Ensure IAM password policy prevents password reuse
...
## Description
Password reuse allows a single phish to compromise many systems.
...
## Audit Procedure
1. `aws iam get-account-password-policy | jq .PasswordReusePrevention`.
...
## Remediation
Set `PasswordReusePrevention >= 24`.
