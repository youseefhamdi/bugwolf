# CIS AWS Foundations 2.0 — 5.1.1 Ensure RDS IAM authentication is enabled
...
## Description
Ensure RDS IAM authentication is enabled. RDS, Aurora, and DynamoDB in 2.0 require IAM auth, encryption-at-rest, and automated minor-version upgrades across the fleet.
