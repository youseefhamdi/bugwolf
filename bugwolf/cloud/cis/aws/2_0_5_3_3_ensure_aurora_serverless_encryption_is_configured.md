# CIS AWS Foundations 2.0 — 5.3.3 Ensure Aurora Serverless encryption is configured
...
## Description
Ensure Aurora Serverless encryption is configured. RDS, Aurora, and DynamoDB in 2.0 require IAM auth, encryption-at-rest, and automated minor-version upgrades across the fleet.
