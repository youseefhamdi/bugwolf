# CIS AWS Foundations 1.0 — 5.5 Ensure RDS performance insights are enabled
...
## Description
Performance Insights helps triage incidents.
...
## Audit Procedure
1. `aws rds describe-db-instances | jq '.DBInstances[].PerformanceInsightsEnabled'`.
...
## Remediation
Enable Performance Insights with a 7-day retention.
