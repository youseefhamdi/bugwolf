# CIS AWS Foundations 2.0 — 3.6.6 Ensure VPC flow logs are enabled at the VPC level
...
## Description
Ensure VPC flow logs are enabled at the VPC level. VPC and edge controls in 2.0 mandate explicit deny-by-default Security Groups, central egress via NAT, and TLS-only listeners across the public surface.
