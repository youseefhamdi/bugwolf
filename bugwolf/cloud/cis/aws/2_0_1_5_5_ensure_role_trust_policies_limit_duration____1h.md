# CIS AWS Foundations 2.0 — 1.5.5 Ensure role trust policies limit duration <= 1h
...
## Description
Ensure role trust policies limit duration <= 1h. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
