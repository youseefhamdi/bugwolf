# CIS AWS Foundations 2.0 — 1.9.9 Ensure sts:AssumeRole cannot be invoked from wildcard
...
## Description
Ensure sts:AssumeRole cannot be invoked from wildcard. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
