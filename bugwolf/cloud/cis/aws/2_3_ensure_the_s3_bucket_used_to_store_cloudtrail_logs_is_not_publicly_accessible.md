# CIS AWS Foundations 1.0 — 2.3 Ensure the S3 bucket used to store CloudTrail logs is not publicly accessible
...
## Description
Public CloudTrail buckets leak every API call.
...
## Audit Procedure
1. Inspect the bucket policy; reject any `Principal: *`.
...
## Remediation
Apply the AWS-managed CloudTrail bucket policy verbatim.
