# CIS AWS Foundations 2.0 — 4.1.1 Ensure S3 Block Public Access is enabled at the account level
...
## Description
Ensure S3 Block Public Access is enabled at the account level. S3 and EBS in 2.0 mandate default-deny public access at the account level via Block Public Access, SSE-KMS for regulated data, and object-lock for compliance retention.
