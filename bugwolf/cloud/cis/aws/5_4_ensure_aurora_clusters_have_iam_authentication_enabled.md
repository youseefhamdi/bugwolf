# CIS AWS Foundations 1.0 — 5.4 Ensure Aurora clusters have IAM authentication enabled
...
## Description
Passwordless auth avoids long-lived DB credentials.
...
## Audit Procedure
1. `aws rds describe-db-clusters | jq '.DBClusters[].IAMDatabaseAuthenticationEnabled'`.
...
## Remediation
Enable IAM auth; rotate static passwords out of band.
