# CIS AWS Foundations 1.0 — 4.2 Ensure S3 buckets require requests to use Secure Transport
...
## Audit Procedure
1. Inspect bucket policy for `aws:SecureTransport = false`.
