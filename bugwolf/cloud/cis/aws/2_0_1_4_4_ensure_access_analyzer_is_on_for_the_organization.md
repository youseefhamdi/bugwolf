# CIS AWS Foundations 2.0 — 1.4.4 Ensure access analyzer is on for the organization
...
## Description
Ensure access analyzer is on for the organization. IAM hygiene in the Foundations 2.0 lineage extends the v1 controls to organization-wide coverage, fine-grained SCP authoring, and delegation patterns that emerged after the original 2018 baseline.
