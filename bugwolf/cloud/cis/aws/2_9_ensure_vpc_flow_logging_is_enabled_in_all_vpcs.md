# CIS AWS Foundations 1.0 — 2.9 Ensure VPC flow logging is enabled in all VPCs
...
## Description
VPC flow logs are the only native way to capture inter-VPC traffic.
...
## Remediation
Enable flow logs at the VPC level; deliver to CW Logs.
