# CIS AWS Foundations 1.0 — 1.18 Ensure IAM instance roles are used for AWS resource access
...
## Description
Long-lived instance credentials are an exfil vector; use instance profiles instead.
...
## Audit Procedure
1. Inspect EC2 metadata for `iam/security-credentials/`.
...
## Remediation
Migrate to instance profiles; remove any stored access keys.
