# CIS AWS Foundations 2.0 — 4.5.5 Ensure S3 event notifications are routed to EventBridge
...
## Description
Ensure S3 event notifications are routed to EventBridge. S3 and EBS in 2.0 mandate default-deny public access at the account level via Block Public Access, SSE-KMS for regulated data, and object-lock for compliance retention.
