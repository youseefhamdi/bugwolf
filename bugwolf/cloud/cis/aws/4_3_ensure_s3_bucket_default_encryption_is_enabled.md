# CIS AWS Foundations 1.0 — 4.3 Ensure S3 bucket default encryption is enabled
...
## Description
Server-side encryption is the baseline for data at rest.
...
## Audit Procedure
1. `aws s3api get-bucket-encryption --bucket <name>`.
...
## Remediation
Enable SSE-S3 or SSE-KMS; default-encrypt all PUTs.
