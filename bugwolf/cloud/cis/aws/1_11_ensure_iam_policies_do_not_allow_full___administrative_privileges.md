# CIS AWS Foundations 1.0 — 1.11 Ensure IAM policies do not allow full * administrative privileges
...
## Description
Wildcard admin policies are the most common privilege-escalation primitive.
...
## Audit Procedure
1. Run `aws iam get-account-authorization-details | jq '.Policies[].PolicyDocument.Statement[] | select(.Action == "*" or .Action[] == "*")'`.
...
## Remediation
Tighten Action and Resource lists; prefer managed policies with explicit lists.
