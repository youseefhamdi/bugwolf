# CIS AWS Foundations 1.0 — 1.20 Ensure IAM users with console access use strong password policy
...
## Description
Ensure the account-wide password policy meets the CIS minimum (length ≥ 14, complexity enabled).
...
## Remediation
Update the policy; communicate to all human users.
