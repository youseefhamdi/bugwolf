# CIS AWS Foundations 1.0 — 2.5 Ensure AWS Config is enabled in all regions
...
## Description
AWS Config records resource configuration changes; absence means no change-history.
...
## Audit Procedure
1. `aws configservice describe-configuration-recorders`.
...
## Remediation
Enable AWS Config in every active region; deliver to a central account.
