# CIS AWS Foundations 1.0 — 3.4 Ensure routing tables for VPC peering are 'least access'
...
## Description
Peering routes can over-share CIDR ranges.
...
## Audit Procedure
1. `aws ec2 describe-route-tables | jq '.RouteTables[].Routes'`.
...
## Remediation
Constrain peered routes to the minimal CIDRs required.
