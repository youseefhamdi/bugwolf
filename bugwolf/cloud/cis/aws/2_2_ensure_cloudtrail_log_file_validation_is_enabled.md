# CIS AWS Foundations 1.0 — 2.2 Ensure CloudTrail log file validation is enabled
...
## Description
Log file integrity validation detects post-hoc tampering.
...
## Audit Procedure
1. `aws cloudtrail describe-trails | jq '.trailList[] | .LogFileValidationEnabled'`.
