# CIS AWS Foundations 1.0 — 1.21 Ensure IAM users have MFA enabled for CLI access
...
## Description
Programmatic users without MFA can't enforce 2FA at the API layer; use `aws:MultiFactorAuthPresent`.
...
## Audit Procedure
1. Inspect SCPs for `aws:MultiFactorAuthPresent` denies.
...
## Remediation
Add `aws:MultiFactorAuthPresent` to sensitive IAM policies.
