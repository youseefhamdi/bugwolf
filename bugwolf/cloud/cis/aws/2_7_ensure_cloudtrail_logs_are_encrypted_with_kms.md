# CIS AWS Foundations 1.0 — 2.7 Ensure CloudTrail logs are encrypted with KMS
...
## Description
Unencrypted CloudTrail logs expose IAM activity, secret references, and ARNs.
...
## Audit Procedure
1. Inspect the trail's `KMSKeyId`.
...
## Remediation
Create / attach a CMK with a key policy that grants decrypt to auditors only.
