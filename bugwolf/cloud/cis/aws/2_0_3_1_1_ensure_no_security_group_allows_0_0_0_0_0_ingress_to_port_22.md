# CIS AWS Foundations 2.0 — 3.1.1 Ensure no Security Group allows 0.0.0.0/0 ingress to port 22
...
## Description
Ensure no Security Group allows 0.0.0.0/0 ingress to port 22. VPC and edge controls in 2.0 mandate explicit deny-by-default Security Groups, central egress via NAT, and TLS-only listeners across the public surface.
