# CIS AWS Foundations 2.0 — 3.5.5 Ensure the default Security Group restricts all traffic
...
## Description
Ensure the default Security Group restricts all traffic. VPC and edge controls in 2.0 mandate explicit deny-by-default Security Groups, central egress via NAT, and TLS-only listeners across the public surface.
