# CIS AWS Foundations 1.0 — 2.4 Ensure CloudTrail trails are integrated with CloudWatch Logs
...
## Description
CW Logs integration unlocks alerting on AWS API events.
...
## Audit Procedure
1. `aws cloudtrail describe-trails | jq '.trailList[] | .CloudWatchLogsLogGroupArn'`.
...
## Remediation
Configure CloudWatch Logs integration via the console or CLI.
