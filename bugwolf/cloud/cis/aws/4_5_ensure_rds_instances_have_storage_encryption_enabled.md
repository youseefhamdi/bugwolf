# CIS AWS Foundations 1.0 — 4.5 Ensure RDS instances have storage encryption enabled
...
## Audit Procedure
1. `aws rds describe-db-instances | jq '.DBInstances[].StorageEncrypted'`.
...
## Remediation
Re-create the instance with encryption (snapshot-copy).
