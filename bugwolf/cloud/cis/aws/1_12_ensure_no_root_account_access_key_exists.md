# CIS AWS Foundations 1.0 — 1.12 Ensure no root account access key exists
...
## Description
A root access key is not required for any normal operation and is a prime target.
...
## Audit Procedure
1. `aws iam get-account-summary | jq .AccountAccessKeysPresent`.
...
## Remediation
Delete the root access key: `aws iam delete-access-key --access-key-id <id> --user-name root`.
