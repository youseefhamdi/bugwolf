# CIS AWS Foundations 1.0 — 1.4 Ensure IAM users receive permissions only via groups
...
## Description
Permissions must aggregate through group membership to remain auditable.
...
## Audit Procedure
1. Compare `aws iam list-attached-user-policies` and `aws iam list-groups-for-user`.
...
## Remediation
Move all user-level permissions into groups; revoke direct attachments.
