# CIS AWS Foundations 1.0 — 4.6 Ensure S3 lifecycle policies are configured
...
## Description
Lifecycle rules prevent unbounded retention.
...
## Audit Procedure
1. `aws s3api get-bucket-lifecycle-configuration`.
...
## Remediation
Configure lifecycle transitions to IA / Glacier.
