# CIS AWS Foundations 1.0 — 1.16 Ensure IAM users with console access have MFA enabled
...
## Description
Same as 1.9 — included as a separate Prowler hook.
...
## Audit Procedure
1. Use Prowler check `iam_user_mfa_enabled_console_access`.
...
## Remediation
Enroll the user in MFA; deny console access until enrolled.
