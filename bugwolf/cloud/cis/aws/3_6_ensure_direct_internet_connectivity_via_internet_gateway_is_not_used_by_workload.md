# CIS AWS Foundations 1.0 — 3.6 Ensure direct internet connectivity via internet gateway is not used by workloads
...
## Description
Workloads should egress via NAT, not via public IPs.
...
## Audit Procedure
1. Inspect ENI `AssociatePublicIpAddress`.
...
## Remediation
Move workloads to private subnets; use NAT Gateway for egress.
