# CIS GCP 4.1 — Ensure Cloud Storage buckets are not publicly readable
...
## Description
Ensure Cloud Storage buckets are not publicly readable. Uniform bucket-level access + block-public-access.
