# CIS GCP 5.3 — Ensure BigQuery query results are not cached for sensitive jobs
...
## Description
Ensure BigQuery query results are not cached for sensitive jobs. Disable result cache on regulated workloads.
