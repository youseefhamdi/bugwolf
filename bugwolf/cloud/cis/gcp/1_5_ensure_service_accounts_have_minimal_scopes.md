# CIS GCP 1.5 — Ensure service accounts have minimal scopes
...
## Description
Ensure service accounts have minimal scopes. Avoid user-managed service account keys where possible.
