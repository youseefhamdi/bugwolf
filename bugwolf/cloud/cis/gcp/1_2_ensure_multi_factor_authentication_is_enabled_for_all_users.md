# CIS GCP 1.2 — Ensure multi-factor authentication is enabled for all users
...
## Description
Ensure multi-factor authentication is enabled for all users. 2SV enforced via Google Workspace.
