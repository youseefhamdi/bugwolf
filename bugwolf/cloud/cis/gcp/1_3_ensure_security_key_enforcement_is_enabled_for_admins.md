# CIS GCP 1.3 — Ensure Security Key enforcement is enabled for admins
...
## Description
Ensure Security Key enforcement is enabled for admins. Hardware-key MFA for super-admin.
