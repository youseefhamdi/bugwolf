# CIS GCP 3.1 — Ensure default networks are removed from projects
...
## Description
Ensure default networks are removed from projects. Replace the default network with a custom VPC.
