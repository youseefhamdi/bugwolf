...
Tool modules (BugWolf internals driven via Bash -- always through tools/runtime/sandbox.py): hunt, differential_runner, header_trust, cache_traversal, surface_model
